...
android {
    ...
    packaging {
        ...
        // Bellek optimizasyonu için daha hızlı paketleme
...
dependencies {
    ...
    // implementation(project(":feature:pokemon-teams"))
    ...
    // Compose Preview için gerekli bağımlılıklar
